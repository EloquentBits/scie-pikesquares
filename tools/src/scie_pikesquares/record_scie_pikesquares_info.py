...
from scie_pikesquares.log import fatal, init_logging
...
def main() -> NoReturn:
    ...
    init_logging(base_dir=options.base_dir, log_name="record-scie-pikesquares-info")
    ...
    version = subprocess.run(
        args=[options.scie],
        env={"PIKESQUARES_BOOTSTRAP_VERSION": "report"},
